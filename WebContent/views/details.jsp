...
<div>
	...
	<%
		...
		if(request.getParameter("origin").equals("Home")){
			listings = (HashMap<Integer, Listing>)currentSession.getAttribute("LatestItems");
		...
		out.println("<div class='col-md-12 col-md-offset-6 panel panel-default'>"+
					"<div class='row'>"+
						...
						"<div class='form-group panel-body col-md-6'>"+
							...
							"<input type=text name=enteredbid class='form-control col-md-2'>"+
					    ...
					    "<tr><td>Leisure</td><td>Nearly New</td></tr></table>"+
						"</div></div>"+
					"</div>");
